...
# Example: sudo /var/ossec/bin/manage_agents -e 001
```
...
**Create group**
```
sudo /var/ossec/bin/agent_groups -a -g "WindowsPC-Prod"
```
...
**Check Groups**
```
sudo  /var/ossec/bin/agent_groups
```
...
Set Manager IP (Debian IP) in ossec.conf
```
sudo nano /var/ossec/etc/ossec.conf

<client>
  <server>
    <address>MANAGER_IP</address>   <!-- ← Change this to Debian IP-->
    <port>1514</port>
...
# Then enable and start via systemd
```
